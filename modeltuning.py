...
model = RandomizedSearchCV(estimator = model, param_grid = random_grid, cv = 3, verbose=2, n_jobs = -1, n_iter = 50)
print("Fitting model")
model.fit(X_train, y_train)
pprint(model.best_params_)
model = model.best_estimator_
print("Saving model")
joblib.dump(model, "RandomForestRegressorRandomizedSearchCV2.pkl")
#print("Loading model")
