...
model1 = RegressorChain(model)
model2 = MultiOutputRegressor(model, n_jobs = -1)
model1.fit(X_train, y_train)
joblib.dump(model1, "RegressorChainGradientBoostingRegressorEarnings.pkl")
print("Model 1: ");
accuracy(model1, X_test, y_test)
model2.fit(X_train, y_train)
joblib.dump(model2, "MultipleOutputGradientBoostingRegressorEarnings.pkl")
print("Model 2: ");
...
model1.fit(X_train, y_train)
joblib.dump(model1, "RegressorChainGradientBoostingRegressorRepayment.pkl")
print("Model 3: ");
accuracy(model1, X_test, y_test)
model2.fit(X_train, y_train)
joblib.dump(model2, "MultipleOutputGradientBoostingRegressorRepayment.pkl")
print("Model 4: ");
accuracy(model2, X_test, y_test)
